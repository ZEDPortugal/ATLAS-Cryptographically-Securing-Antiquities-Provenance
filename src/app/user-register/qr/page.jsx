      ...
      <div className="w-full max-w-2xl space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Save your QR code and hash key to login
          </p>
        </div>
        ...
        <div className="rounded-lg bg-yellow-500/10 px-4 py-3 text-sm text-yellow-200 ring-1 ring-yellow-500/20">
          <strong>⚠️ Important:</strong> Save both the QR code and hash key
          securely. You'll need them to login.
        </div>
      </div>
    </div>
  );
...
export default function UserRegisterQRPage() {
  return (
    <Suspense
      fallback={
